...
@Component
public class ToLogDTO implements Converter<Log, LogDTO> {
    /**
     ...
     */
    @Override
    public final LogDTO convert(Log s) {
        return new LogDTO(s.getId(), s.getESwitch(), s.getEStatus(), s.getReqDateTime(), s.getRespDateTime());
    }
}
